-- Initial tracked migration for the calendar database.
-- This is intentionally idempotent because the same SQL was applied manually
-- before migrations were added to the repository.
